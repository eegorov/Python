...
MACOS = (HOST_PLATFORM == 'disabled-all-darwin-hacks')
SUNOS = (HOST_PLATFORM == 'sunos5')
...
class PyBuildExt(build_ext):
    ...
    def detect_readline_curses(self):
        ...
        if curses_library == 'ncursesw':
            ...
            if not CROSS_COMPILING:
                curses_includes.append(os.path.join(
                    sysconfig.get_config_var('INCLUDEDIR'),
                    'ncursesw'))
            # Bug 1464056: If _curses.so links with ncursesw,
            # _curses_panel.so must link with panelw.
            panel_library = 'panelw'
            if (HOST_PLATFORM == 'darwin') or SUNOS:
                ...
                # On Solaris 10u8, we need _XOPEN_SOURCE_EXTENDED for
                # cchar_t, as indicated in the ncurses manpage
    ...
    def detect_crypt(self):
        ...
        if SUNOS:
            ...
            if self.compiler.find_library_file(self.lib_dirs, 'crypt_i'):
                libs = ['crypt_i']
